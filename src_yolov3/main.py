...
flags.DEFINE_string('weights', './weight/yolov3-tiny.tf',
...
def main(_argv):
    ...
    #out = cv2.VideoWriter("yolov3_recode.mp4", codec, fps, (590,720))
    ...
    while cap_main.isOpened():
        ...
        for i in range(len(person_boxes)):
            ...
            #cv2.rectangle(frame_main, (x1, y1), (x2, y2), (0,0,255),4)
        ...
        #draw_rectangle(frame_main,ball_list,(255,0,0))
